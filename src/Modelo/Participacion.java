...
private boolean ConfirmacionParticipacion;
    ...
    public void setConfirmacionParticipacion(boolean ConfirmacionParticipacion) {
        this.ConfirmacionParticipacion = ConfirmacionParticipacion;
    }

    public double getTiempoDeCarrera() {
        return tiempoDeCarrera;
    }

    public void setTiempoDeCarrera(double tiempoDeCarrera) {
